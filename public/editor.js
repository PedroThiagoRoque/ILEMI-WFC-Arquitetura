...
const rules = {
  0: [1, 2, 3,4,5,6], // 0 pode estar próximo a 1, 2 ou 3
  1: [0, 4],    // 1 pode estar próximo a 0 ou 4
  2: [0, 3, 5],    // 2 pode estar próximo a 3 ou 5
  3: [0, 2, 6],    // 3 pode estar próximo a 2 ou 6
  4: [0, 1, 5],    // 4 pode estar próximo a 1 ou 5
  5: [0, 2, 4, 6], // 5 pode estar próximo a 2, 4 ou 6
  6: [0, 3, 5],    // 6 pode estar próximo a 3 ou 5
};
